...
class TestPublisher(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as path:
            ...
            with open(filepath, encoding='utf-8') as r:
                ...
                self.assertEqual(
                    r'''{
  "title": "1 parse errors, 1 errors, 3 fail, 2 skipped, 1 pass in 7s",
  "summary": "1 files   1 errors  2 suites   7s :stopwatch:\n7 tests  1 :white_check_mark: 2 :zzz: 3 :x: 1 :fire:\n3 runs  -12 :white_check_mark: 4 :zzz: 5 :x: 6 :fire:\n\nResults for commit commit.\n",
  "conclusion": "conclusion",
  "stats": {
    "files": 1,
    "errors": [
  ...
  "annotations": [
    ...
    },
    {
      ...
      "message": "result [took 3s]",
      "title": "test3 (class1) failed",
      "raw_details": "message3\ncontent3\nstdout3\nstderr3"
    },
    {
      "path": "test",
      "start_line": 123,
      "end_line": 123,
      "annotation_level": "failure",
      "message": "result [took 4s]",
      "title": "test1 (class2) with error",
      "raw_details": "message4\ncontent4\nstdout4\nstderr4"
    },
    {
      "path": "test",
      "start_line": 123,
      "end_line": 123,
      "annotation_level": "warning",
      "message": "result [took 6s]",
      "title": "test3 (class2) failed",
      "raw_details": "message6\ncontent6\nstdout6\nstderr6"
    },
    {
      "path": "test",
      "start_line": 123,
      "end_line": 123,
      "annotation_level": "warning",
      "message": "result [took 7s]",
      "title": "test4 (class2) failed",
      "raw_details": "message7\ncontent7\nstdout7\nstderr7"
    },
    {
      "path": ".github",
      "start_line": 0,
